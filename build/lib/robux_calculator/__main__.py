...
robux_entry_label.grid(row=2, column=0, columnspan=1, padx=0, pady=10)

# Create the entry field for Robux input
robux_entry = tk.Entry(root, width=6, borderwidth=2)
robux_entry.grid(row=2, column=1, columnspan=1, padx=0, pady=10)
...
usd_entry_label.grid(row=2, column=2, columnspan=1, padx=10, pady=10)

# Create the entry field for USD output
usd_entry = tk.Entry(root, width=6, borderwidth=2)
usd_entry.grid(row=2, column=3, columnspan=1, padx=0, pady=10)
